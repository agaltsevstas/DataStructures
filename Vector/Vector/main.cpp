...
int main()
{
    // Vector
    {
        ...
        Vector<bool> vector_bool(10, false);
        vector_bool[5] = true;
        ...
        Vector<int> vector3;
        vector3 = vector;
        Vector<int> vector4(std::move(vector2));
        Vector<int> vector5;
        vector5 = std::move(vector3);
        vector4.Swap(vector5);
        Vector<int> vector6 = {1, 2, 3};
        ...
        Vector<Example> examples_copy = examples;
